...
export class CommentMigration1628488785682 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "blogs" ALTER COLUMN "meta_title" DROP NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_b9e1eb8aea30ea2192cd8f0a31" ON "blogs" ("title") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "blogs" ALTER COLUMN "meta_title" SET NOT NULL`);
