...
export class renameBlogTagTable1628686044524 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "blogs_tags" ("blogs" uuid NOT NULL, "tags" uuid NOT NULL, CONSTRAINT "PK_112213035d78c06a21cd281b589" PRIMARY KEY ("blogs", "tags"))`);
        ...
        await queryRunner.query(`ALTER TABLE "categories" ALTER COLUMN "meta_title" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "blogs" ALTER COLUMN "is_draft" SET DEFAULT true`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "blogs" ALTER COLUMN "is_draft" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "categories" ALTER COLUMN "meta_title" SET NOT NULL`);
