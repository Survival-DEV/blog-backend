...
export class BlogsMigration1624991187241 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(50) NOT NULL, "meta_title" character varying NOT NULL, "slug" character varying NOT NULL, "parent_id" character varying, CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tags" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "meta_title" character varying NOT NULL, "slug" character varying NOT NULL, CONSTRAINT "PK_e7dc17249a1148a1970748eda99" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "blogCategory" ("blogsId" uuid NOT NULL, "categoriesId" uuid NOT NULL, CONSTRAINT "PK_b6eda678568c89242be2f372d8d" PRIMARY KEY ("blogsId", "categoriesId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_055a75bd8761259f0c600cb16a" ON "blogCategory" ("blogsId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b3aa4f5e8cbda73c40d04bec53" ON "blogCategory" ("categoriesId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "blogCategory" ADD CONSTRAINT "FK_055a75bd8761259f0c600cb16a1" FOREIGN KEY ("blogsId") REFERENCES "blogs"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "blogCategory" ADD CONSTRAINT "FK_b3aa4f5e8cbda73c40d04bec535" FOREIGN KEY ("categoriesId") REFERENCES "categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "blogCategory" DROP CONSTRAINT "FK_b3aa4f5e8cbda73c40d04bec535"`,
    );
    await queryRunner.query(
      `ALTER TABLE "blogCategory" DROP CONSTRAINT "FK_055a75bd8761259f0c600cb16a1"`,
    );
    await queryRunner.query(
